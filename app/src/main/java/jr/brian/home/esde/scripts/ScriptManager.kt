...
"""
        ...
        val systemSelectScript =
            File(File(scriptsDir, "system-select"), "esdecompanion-system-select.sh")
...
"""
        ...
        val screensaverStartScript =
            File(File(scriptsDir, "screensaver-start"), "esdecompanion-screensaver-start.sh")
...
"""
        ...
        val screensaverEndScript =
            File(File(scriptsDir, "screensaver-end"), "esdecompanion-screensaver-end.sh")
    ...
    fun validateScripts(scriptsDir: File): ScriptValidationResult {
        ...
        for ((scriptPath, pattern) in requiredScripts) {
            ...
            try {
                ...
                Log.e("ScriptManager", "Error reading script: $scriptPath", e)
                invalidScripts.add(scriptName)
            }
        }
