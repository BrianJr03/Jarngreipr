                                            ...
                                            when (joystickMode) {
                                                JoystickMode.LEFT_ONLY -> {
                                                    ...
                                                    touchStartPosition?.let { start ->
                                                        ...
                                                        val x = (offsetX / joystickRadius).coerceIn(
                                                            -1f,
                                                            1f
                                                        )
                                                        val y = (offsetY / joystickRadius).coerceIn(
                                                            -1f,
                                                            1f
                                                        )
                                                ...
                                                JoystickMode.LEFT_RIGHT -> {
                                                    if (touchStartedOnLeft) {
                                                        ...
                                                        touchStartPosition?.let { start ->
                                                            ...
                                                            val offsetY = currentPos.y - start.y
                                                            val x =
                                                                (offsetX / joystickRadius).coerceIn(
                                                                    -1f,
                                                                    1f
                                                                )
                                                            val y =
                                                                (offsetY / joystickRadius).coerceIn(
                                                                    -1f,
                                                                    1f
                                                                )
                                                            ShizukuInputManager.injectLeftJoystick(
                                                                x,
                                                                y
                                                            )
                                                        }
